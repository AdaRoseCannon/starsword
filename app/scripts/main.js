...
var buffers = ['./audio/hum.wav', './audio/on.wav', './audio/off.wav', './audio/smash.wav'];

var loadedAudio = new Promise(function (resolve, reject) {
	loader(buffers, context, function (err, loadedBuffers) {
...
loadedAudio.then(function (_ref) {
	var _ref2 = _slicedToArray(_ref, 4);

	var humBuffer = _ref2[0];
	var onBuffer = _ref2[1];
	var offBuffer = _ref2[2];
	var smashBuffer = _ref2[3];

	function StarSword() {
		var _this = this;

		var color = arguments.length <= 0 || arguments[0] === undefined ? '#2FF923' : arguments[0];
...
},{"webaudio-buffer-loader":4}],2:[function(require,module,exports){
(function (process){
/*!
 * async
